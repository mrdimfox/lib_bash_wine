...
function set_lib_bash_wine_permissions {
    ...
    ${sudo_command} chown -R root /usr/lib/lib_bash_wine || ${sudo_command} chown -R ${USER} /usr/lib/lib_bash_wine || echo "giving up set owner" # there is no user root on travis
    ${sudo_command} chgrp -R root /usr/lib/lib_bash_wine || ${sudo_command} chgrp -R ${USER} /usr/lib/lib_bash_wine || echo "giving up set group" # there is no user root on travis
}

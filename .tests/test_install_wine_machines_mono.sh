...
function run_tests {
    ...
    assert_equal "get_mono_version_from_msi_filename wine-mono-4.9.0.msi" "4.9.0"

    assert_equal "get_wine_mono_download_link_from_msi_filename wine-mono-4.9.0.msi" "https://source.winehq.org/winemono.php?v=4.9.0"
    assert_equal "get_wine_mono_download_backup_link_from_msi_filename wine-mono-4.9.0.msi" "https://dl.winehq.org/wine/wine-mono/4.9.0/wine-mono-4.9.0.msi"
    ...
    clr_green "test install mono for 32 Bit wine"
    ...
    clr_green "test install mono for 64 Bit Wine"
    install_wine_mono "${global_wine_prefix}" "${user}"

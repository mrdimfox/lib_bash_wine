    ...
    (
        ...
        if [[ "${wine_arch}" == "win32" ]]
            then
                ...
                wget -nc --no-check-certificate -O powershell.zip https://github.com/PowerShell/PowerShell/releases/download/v${powershell_version}/PowerShell-${powershell_version}-win-x86.zip
            else
